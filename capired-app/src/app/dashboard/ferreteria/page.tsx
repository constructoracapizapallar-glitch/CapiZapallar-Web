...
export default function FerreteriaRadar() {
  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column', height: 'calc(100vh - 80px)', gap: '20px' }}>
      ...
      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-end', paddingBottom: '10px' }}>
        <div>
          <h2 style={{ fontSize: '1.75rem', color: '#292524', margin: '0 0 4px 0', fontWeight: '800', letterSpacing: '-0.5px' }}>Radar de Demanda B2B</h2>
          <p style={{ margin: 0, color: '#78716C', fontSize: '0.85rem' }}>Visualiza Obras Mayores cercanas para ofrecer tus materiales.</p>
        </div>
      </div>
        ...
        <div style={{ width: '400px', display: 'flex', flexDirection: 'column', gap: '15px', overflowY: 'auto', paddingRight: '5px' }}>
          ...
          <div style={{ display: 'flex', gap: '10px' }}>
            <div style={{ flex: 1, background: '#FFFFFF', border: '1px solid #E7E5E4', borderRadius: '6px', padding: '8px 12px', display: 'flex', alignItems: 'center', gap: '8px' }}>
              ...
              <input type="text" placeholder="Buscar constructoras..." style={{ border: 'none', outline: 'none', width: '100%', fontSize: '0.85rem', color: '#292524' }} />
            </div>
              ...
              obras.map((obra) => (
                ...
                >
                  <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', marginBottom: '8px' }}>
                    ...
                    <span style={{ background: '#10B981', color: '#FAFAF9', padding: '2px 6px', borderRadius: '4px', fontSize: '0.65rem', fontWeight: '700' }}>ACTIVA</span>
                  </div>
                  ...
                  <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                    <div style={{ display: 'flex', alignItems: 'center', gap: '4px', color: '#292524' }}>
                      <Package size={14} />
                      <span style={{ fontSize: '0.85rem', fontWeight: '600' }}>Materiales requeridos</span>
                    </div>
                  </div>
                </div>
              ))
            ...
            <div style={{ position: 'absolute', bottom: '20px', left: '20px', right: '20px', background: '#FFFFFF', borderRadius: '12px', padding: '20px', boxShadow: '0 10px 30px rgba(0,0,0,0.1)', border: '1px solid #E7E5E4', zIndex: 1000 }}>
              ...
              <div style={{ display: 'flex', gap: '10px' }}>
                <button style={{ flex: 1, background: '#292524', color: '#FFFFFF', padding: '12px', borderRadius: '8px', border: 'none', fontWeight: '600', fontSize: '0.9rem', cursor: 'pointer', display: 'flex', justifyContent: 'center', alignItems: 'center', gap: '6px' }}>
                  <Zap size={16} /> Contactar Constructora
                </button>
              </div>
            </div>
          )}

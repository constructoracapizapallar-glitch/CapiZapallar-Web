# Roadmap del Proyecto: CapiRed B2B

## Fase 1: Estructura Base y Autenticación
- [x] Configurar Next.js + Firebase Auth.
- [x] Crear modal de Login unificado con redirección por roles.

## Fase 2: Identidad Visual y UI
- [x] Aplicar paleta "Escandinavo Minimalista" (Beige, Carbón, Blanco).
